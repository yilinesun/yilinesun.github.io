    ...
    var vm = new Vue({
        ...
        methods: {
            appendDialog: function appendDialog(id) {
                ...
                getRandomMsg(dialog.details).forEach(function (content) {
                    _this2.msgChain = _this2.msgChain.then(function () {
                        ...
                        return _this2.sendMsg(content, AUTHOR.RAINBOW);
                    });
                });

                return dialog.nextRainbow ? this.appendDialog(dialog.nextRainbow) : this.msgChain.then(function () {
                    _this2.lastDialog = dialog;
                    _this2.isRainbowTyping = false;
                });
            },
            ...
            getDialog: function getDialog(id) {
                ...
                var dialogs = this.dialogs.fromRainbow.filter(function (dialog) {
                    return dialog.id === id;
                });
            ...
            togglePrompt: function togglePrompt(toShow) {
                if (this.isRainbowTyping) {
                    // don't prompt if rainbow is typing
                    return;
                }
            ...
            respond: function respond(response) {
                ...
                return this.say(response.content, response.nextRainbow);
            },
            ask: function ask(fromUser) {
                ...
                return this.say(content, fromUser.nextRainbow);
            },
